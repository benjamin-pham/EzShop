...
public class UserInfoPostEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/api/identity/connect").WithTags("OpenIddict");

        group.MapPost("/userinfo", HandleUserInfoAsync).RequireAuthorization(OpenIddictValidationAspNetCoreDefaults.AuthenticationScheme);
    }
